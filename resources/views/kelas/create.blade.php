            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="/kelas">
                        ...
                        <div class="form-group row">
                            <label for="tahun_ajaran" class="col-sm-4 col-form-label text-md-right">tahun_ajaran</label>

                            <div class="col-md-6">
                                <input id="tahun_ajaran" class="form-control{{ $errors->has('tahun_ajaran') ? ' is-invalid' : '' }}" name="tahun_ajaran" value="{{ old('tahun_ajaran') }}" required autofocus>
